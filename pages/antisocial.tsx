    ...
    >
      <div className="min-h-screen bg-white">
        <div className="container-responsive py-24">
          <ScrollAnimation>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-light tracking-wide text-black mb-16 text-center">
              反社会的勢力排除に関する基本方針
            </h1>
          </ScrollAnimation>
          ...
          <div className="max-w-3xl mx-auto space-y-12">
            ...
            <ScrollAnimation delay={0.3}>
              <section>
                ...
                <ul className="space-y-4 text-base md:text-lg font-light leading-relaxed text-gray-700">
