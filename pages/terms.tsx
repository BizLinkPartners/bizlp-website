          ...
          <div className="max-w-3xl mx-auto space-y-12">
            ...
            <ScrollAnimation delay={0.2}>
              <section>
                ...
                <div className="space-y-4 text-base md:text-lg font-light leading-relaxed text-gray-700">
            ...
            <ScrollAnimation delay={0.4}>
              <section>
                ...
                <ol className="space-y-3 text-base md:text-lg font-light leading-relaxed text-gray-700">
